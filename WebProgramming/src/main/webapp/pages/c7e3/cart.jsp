		...
		<div class="centerDiv">
			...
			<table>
				...
				<c:forEach var="item" items="${cart.items}">
					<tr>
						<td>
							<form action="/api/chap7cart" method="post">
						...
						<td>
							<a href="/api/chap7cart?productCode=${item.product.code}&amp;quantity=0">Remove Item</a>
						</td>
					</tr>
				</c:forEach>
			</table>
			...
			<form action="/c7e3/index" method="post">
				<input type="hidden" name="action" value="shop">
				<input type="submit" value="Continue Shopping">
			</form>
			<form action="/c7e3/checkout" method="post">
